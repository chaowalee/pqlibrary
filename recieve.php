...
if($method == "POST")//เป็นการเลือกวิธีส่งข้อมูลแบบ post เท่านั้น ถ้าส่งเป็น post ให้ทำตามด้านล่าง
{
	...
	$sql = "INSERT INTO librarypq(keyword,type,link) VALUES('$keyword','$type','$link')";//ประกาศตัวแปร sql เพื่อดึงข้อมูลที่ตัวแปร  $keyword บรรทัดที่ 12 มาใส่่ใน insert to library
